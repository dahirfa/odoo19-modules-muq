...
#         fields_list += ['company_id', 'lang', 'is_allow_numpad', 'is_allow_payments',
...
class HrEmployee(models.Model):
    ...
    @api.model
    def _load_pos_data_fields(self, config_id):
        fields_list = super(HrEmployee, self)._load_pos_data_fields(config_id)
        fields_list += ['is_allow_numpad', 'is_allow_payments', 'is_allow_discount', 'is_allow_qty',
