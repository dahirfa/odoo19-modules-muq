...
class InvoicesbyPartner(models.TransientModel):
    ...
    def export_to_excel(self):
        ...
        # Lines
        for group in lines(self.date_from, self.date_to, self.company_id.id, self.partner_id.id, self.invoices_bills):
            # ------------------------------ Partner ------------------------------
            _logger.info("====================== CHECK =========================")
            _logger.info(group)
...
class InvoicesbyPartnerReport(models.AbstractModel):
    ...
    @api.model
    def _lines(self, date_from, date_to, company_id, partner_id, invoices_bills):  # , company_branch_ids
        ...
        key = itemgetter('partner_id', 'partner')
