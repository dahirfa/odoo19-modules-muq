...

{
	...
	""",
    "author": "BROWSEINFO",
    "website": "https://www.browseinfo.com/demo-request?app=pos_disable_payments&version=18&edition=Community",
    "price": 20,
    "currency": "EUR",
    "depends": ["base", "point_of_sale", "pos_hr", "pos_restaurant"],
    "data": [
    ...
    "assets": {
        "point_of_sale._assets_pos": [
            ...
            "pos_disable_payments/static/src/xml/pos.xml",
            "pos_disable_payments/static/src/js/PaymentScreen.js",
            (
                "replace",
                "pos_restaurant/static/src/app/screens/product_screen/actionpad_widget/actionpad_widget.xml",
                "pos_disable_payments/static/src/xml/restuarant_actionpad.xml",
            ),
        ],
    },
    "auto_install": False,
    "installable": True,
    "live_test_url": "https://www.browseinfo.com/demo-request?app=pos_disable_payments&version=18&edition=Community",
